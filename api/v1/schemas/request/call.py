...
class CallInitiateRequest(BaseModel):
    ...
    context: Optional[Dict[str, Any]] = Field(default_factory=dict, description="Additional context for the call")
...
class CallTransferRequest(BaseModel):
    ...
    transfer_type: TransferType = Field(TransferType.BLIND, description="Type of transfer")
...
class CallMuteRequest(BaseModel):
    ...
    muted: bool = Field(..., description="Whether to mute (True) or unmute (False) the call")
