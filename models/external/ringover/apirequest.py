...
class RingoverCallRequest(BaseModel):
    ...
    context: Dict[str, Any] = Field(default_factory=dict, description="Additional call context")
...
class RingoverTransferRequest(BaseModel):
    ...
    transfer_type: str = Field("blind", description="Type of transfer (blind/attended)")
