...
class AgentConfigCreateRequest(BaseModel):
  ...
  tts_provider: str = Field(...,
                            description="TTS provider to use (elevenlabs)")
  voice_settings: Dict[str, Any] = Field(
      default_factory=dict, description="Voice synthesis settings")
...
class AgentConfigUpdateRequest(BaseModel):
  ...
  persona: Optional[str] = Field(
      None, description="Agent persona/character description")
  ...
  voice_settings: Optional[Dict[str, Any]] = Field(
      None, description="Voice synthesis settings")
  active: Optional[bool] = Field(
      None, description="Whether the agent is active")
