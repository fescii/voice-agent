...
class ElevenLabsService:
  ...
  async def get_available_voices(self) -> Dict[str, Any]:
    ...
    try:
      ...
      logger.error(
          f"Error getting voices: {e.response.status_code} - {e.response.text}")
      raise
    except Exception as e:
  ...
  async def get_voice_info(self, voice_id: str) -> Dict[str, Any]:
    ...
    try:
      ...
      logger.error(
          f"Error getting voice info: {e.response.status_code} - {e.response.text}")
      raise
    except Exception as e:
  ...
  async def clone_voice(
    ...
    try:
      ...
      logger.error(
          f"Error cloning voice: {e.response.status_code} - {e.response.text}")
      raise
    except Exception as e:
